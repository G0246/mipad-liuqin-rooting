fastboot %* getvar product 2>&1 | findstr /r /c:"^product: *liuqin" || echo Missmatching image and device
fastboot %* getvar product 2>&1 | findstr /r /c:"^product: *liuqin" || exit /B 1
